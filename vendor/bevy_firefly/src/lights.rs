...
fn queue_lights(
    ...
    for (view, camera, visible_entities, msaa, tonemapping, dither, combined_lightmap) in &views {
        ...
        // PATCH spike (vendor): al primo frame su WebGPU le PointLight2d
        // appena spawnate non sono ancora "visibili" (VisibilityTimer di
        // Bevy 0.19) -> get::<PointLight2d>() e' None e l'unwrap() originale
